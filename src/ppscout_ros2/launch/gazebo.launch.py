...
def generate_launch_description():
    ...
    bridge = Node(
        ...
        parameters=[{
            'config_file': os.path.join(pkg_path, 'params', 'bridge.yaml'),
    ...
    spawn_arm_controllers = Node(
        ...
        arguments=[
            ...
            '--controller', 'gripper_position_controller', '--inactive',
        ],
        output='screen',
    )
